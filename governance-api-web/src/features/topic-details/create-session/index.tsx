  ...
  return (
    <SurfaceCard className="w-full max-w-md shadow-sm">
      <CardHeader className="space-y-2">
        ...
        <CardDescription>
          Open a consultation session for this governance domain and ask the AI about frameworks, processes, and controls.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        <Input
          ...
          placeholder="What governance topic do you want to consult on?"
        />
        <Button
          size="lg"
          className="w-full"
