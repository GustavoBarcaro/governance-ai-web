  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="flex flex-col gap-4 pt-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-2">
            ...
            <h1 className="text-3xl font-extrabold sm:text-4xl">
              Keep your IT governance domains organized.
            </h1>
            <p className="text-muted-foreground">
              Create a domain for each governance area and jump back into the consultations you want to review.
            </p>
          </div>
          ...
          <Card className="border-dashed border-white/60 xl:col-span-3">
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground">
                No governance domains yet. Create your first domain to start consulting.
              </p>
            </CardContent>
          </Card>
        )}
      ...
      <DeleteConfirmDialog
        ...
        description={
          topicToDelete
            ? `This will permanently delete "${topicToDelete.name}" and its consultation history. This action cannot be undone.`
            : ""
        }
