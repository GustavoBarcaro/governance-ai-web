      ...
      <PageHeader
        ...
        description={
          <CardDescription className="max-w-2xl text-base">
            Consult the AI, review answers, and use governance tools without losing the context of this session.
          </CardDescription>
        }
        aside={
          <div className="w-full rounded-[1.5rem] bg-white p-4 shadow-sm sm:max-w-sm">
            ...
            <p className="mt-2 text-sm leading-6">
              Stay focused on{" "}
              <span className="font-semibold">{topicName}</span> and keep your consultations, answers, and governance tools in one place.
            </p>
          </div>
        }
        actions={
